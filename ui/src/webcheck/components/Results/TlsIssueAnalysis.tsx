...
import Button from '@/webcheck/components/Form/Button.tsx';
import Row, { ExpandableRow } from '@/webcheck/components/Form/Row.tsx';
  ...
  return (
    <Card heading={props.title} actionButtons={props.actionButtons}>
      ...
      <Expandable>
        ...
        { tlsRowData.length > 0 && tlsRowData.map((cipherSuite: any, _index: number) => {
          return (
